...
from modules.model_runner.ussr_1dcnn.spatial_reduction_module.base_functions import *
import logging
import numpy as np
from modules.model_runner.ussr_1dcnn.spatial_reduction_module.gdal_lib import gdal_asarray, gdal_transform, rc2coords
from modules.model_runner.ussr_1dcnn.spatial_reduction_module.rl_culster_finder import RLClusterFinder
import pandas as pd
import os
...
class RepLocation:
    ...
    def spatial_sampling(self, run_id, dem_asc_file, max_inun_file, sampling_dist):
        ...
        shp_output_file=f'ss_{sampling_dist}_{run_id}.shp'
...
def find_representative_locations_and_clusters(run_id, sampling_dist, n_clusters=10, random_state=42, n_init=10):
    ...
    # Run clustering
    rl_clusters_file_path = cluster_finder.run_clustering()
    ...
    meta_data = {
        ...
        'rl_clusters_file_path': rl_clusters_file_path
    }
    ...
    logger.info(f"Representative locations and clusters found and saved to {rl_file_path} and {rl_clusters_file_path} with sampling distance {sampling_dist}")
    return rl_file_path, rl_clusters_file_path
